...
const Mixer: React.FC<Props> = () => {
  ...
  return (
    <div className="bridge-container">
      <div id="bridge" className="h-12 relative" />
        ...
        >
          ...
          <div className="w-full border border-gray-500 rounded-2xl pl-2 pt-2 pr-2">
            ...
            <Input
              ...
              className="w-full mx-auto my-2 !border-t-0 !border-l-0 !border-r-0 focus:border-b-lime-500 !shadow-none !outline-none"
              color={"white"}
          ...
          <div className="w-full flex flex-wrap justify-evenly mt-4 text-center">
            <Button
              ...
              className="w-full rounded-xl text-white bg-lime-500 hover:bg-lime-600 active:bg-lime-600 disabled:bg-lime-500 focus:bg-lime-600 hover:disabled:bg-lime-400"
            >
              Bridge
            </Button>
          </div>
